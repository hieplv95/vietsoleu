...
export default function Footer() {
  ...
  const footerLinks = {
    [t('footer.col_features')]: [
      { label: t('footer.link_webSeo'), href: '/thiet-ke-website-nails' },
      ...
      <div className="container footer__inner">
        <div className="footer__brand">
          ...
          <div className="footer__socials">
            ...
            <a href="https://wa.me/34642805848" className="footer__social footer__social--whatsapp" target="_blank" rel="noreferrer" aria-label="WhatsApp">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
