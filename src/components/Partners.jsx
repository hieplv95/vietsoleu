    ...
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 160 48" height="44" fill="none" xmlns="http://www.w3.org/2000/svg" className="partner-svg">
          ...
          <text x="32" y="32" fontFamily="'Inter', 'Product Sans', sans-serif" fontWeight="700" fontSize="26" fill="#4285F4" letterSpacing="-0.5">Google</text>
        </svg>
      )
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 170 48" height="44" fill="none" xmlns="http://www.w3.org/2000/svg" className="partner-svg">
          ...
          <text x="44" y="32" fontFamily="'Inter', sans-serif" fontWeight="800" fontSize="24" fill="#1877F2" letterSpacing="-0.5">facebook</text>
        </svg>
      )
    },
    {
    ...
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 190 48" height="44" fill="none" xmlns="http://www.w3.org/2000/svg" className="partner-svg">
          ...
          <text x="38" y="39" fontFamily="'Inter', sans-serif" fontWeight="700" fontSize="10" fill="#B38F24" letterSpacing="3">NAILS & SPA</text>
        </svg>
      )
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 190 48" height="44" fill="none" xmlns="http://www.w3.org/2000/svg" className="partner-svg">
          ...
          <text x="34" y="39" fontFamily="'Inter', sans-serif" fontWeight="700" fontSize="9" fill="#DB2777" letterSpacing="2.5">BEAUTY SALON</text>
        </svg>
      )
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 200 48" height="44" fill="none" xmlns="http://www.w3.org/2000/svg" className="partner-svg">
          ...
          <text x="42" y="27" fontFamily="'Inter', sans-serif" fontWeight="900" fontSize="19" fill="#8B5CF6" letterSpacing="1.5">ROYAL</text>
          <text x="42" y="39" fontFamily="'Inter', sans-serif" fontWeight="800" fontSize="10" fill="#7C3AED" letterSpacing="3">ART NAILS</text>
        </svg>
      )
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 210 48" height="44" fill="none" xmlns="http://www.w3.org/2000/svg" className="partner-svg">
          ...
          <text x="40" y="27" fontFamily="'Inter', sans-serif" fontWeight="900" fontSize="19" fill="#0891B2" letterSpacing="1">GLAMOUR</text>
          <text x="40" y="39" fontFamily="'Inter', sans-serif" fontWeight="700" fontSize="10" fill="#06B6D4" letterSpacing="2.5">NAILS STUDIO</text>
        </svg>
      )
    }
  ]
