    ...
    <section className="cta section" id="contact">
      ...
      <div className="container cta__inner">
        ...
        <div className="cta__actions">
          <a href="#pricing" className="btn btn-primary btn-lg cta__btn-primary">
            <span>Bắt đầu 14 ngày miễn phí</span>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
              <path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
            </svg>
          </a>
          <a href="https://wa.me/+32" className="btn btn-secondary btn-lg cta__btn-whatsapp" target="_blank" rel="noreferrer">
